 ...
 */
abstract class AbstractRaoComputationRunnerPane<T extends ProjectNode> extends GridPane {

    protected static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("lang.Rao");
    ...
    protected AbstractRaoComputationRunnerPane(T node, Scene scene, GseContext context) {
