...
abstract class AbstractFlowBasedComputationRunnerPane<T extends ProjectNode> extends GridPane {
    ...
    protected static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("lang.FlowBased");
    ...
    protected AbstractFlowBasedComputationRunnerPane(T node, Scene scene, GseContext context) {
